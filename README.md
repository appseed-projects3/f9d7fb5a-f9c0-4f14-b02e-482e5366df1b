...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-20 07:17`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f9d7fb5a-f9c0-4f14-b02e-482e5366df1b.git
$ cd f9d7fb5a-f9c0-4f14-b02e-482e5366df1b
```
